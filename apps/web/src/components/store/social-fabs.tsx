...
export function SocialFabs() {
  ...
  if (!waNumber && !igUrl) return null;

  const waUrl = waNumber
    ? buildWhatsAppSupportUrl(
        waNumber,
        "Hi, I have a question about THARAGAI products.",
      )
    : null;

  return (
    <div className="fixed bottom-20 right-4 z-[var(--z-fab)] flex flex-col gap-3 md:bottom-6">
      {waUrl ? (
        <a
          href={waUrl}
          target="_blank"
...
/** @deprecated Use SocialFabs */
export { SocialFabs as WhatsAppFab };
