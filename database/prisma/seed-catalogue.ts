...
export async function seedCatalogue(prisma: PrismaClient) {
  ...
  const templates = [
    ...
    { prefix: "Wedding Silk Saree", category: "sarees", brand: "silk-house", gender: "Women", occasion: "Wedding", base: 8999 },
    { prefix: "Festival Softsilk Saree", category: "sarees", brand: "festival-lane", gender: "Women", occasion: "Festival", base: 4499 },
